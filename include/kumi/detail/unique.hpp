...
namespace kumi::_
{
  ...
  template<std::size_t I, typename T> consteval auto get_name()
  {
    using type = std::remove_cvref_t<T>;
    if constexpr ( requires { type::is_field_capture; } )
      return value_identity< type::name >{}; 
    else
      return value_identity< I >{};
  }
