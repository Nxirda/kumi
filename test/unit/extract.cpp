...
TTS_CASE("Check tuple::extract behavior on named tuples")
{
  using namespace kumi::literals;

  kumi::tuple t = {"x"_m = '1', "y"_m = 2., "z"_m = 3.f, "t"_m = 4};
...
TTS_CASE("Check tuple::extract constexpr behavior on named tuple")
{
  using namespace kumi::literals;

  constexpr kumi::tuple t = {"x"_m = '1', "y"_m = 2., "z"_m = 3.f, "t"_m = 4};
