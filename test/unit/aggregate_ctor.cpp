...
TTS_CASE("Check construction of kumi::tuple with names as an aggregate")
{
  using namespace kumi::literals;
  auto t0 = kumi::tuple{};
  auto t1 = kumi::tuple{"x"_m = 1};
  auto t2 = kumi::tuple{"x"_m = 1.f, "y"_m = 2};
  auto t3 = kumi::tuple{"x"_m = 1., "y"_m = 2.f, "z"_m = 3};
  auto t4 = kumi::tuple{"x"_m = '1', 2., "z"_m = 3.f, 4};
...
TTS_CASE("Check construction of kumi::tuple with names as a constexpr aggregate")
{
  using namespace kumi::literals;
  constexpr auto t0 = kumi::tuple{};
  constexpr auto t1 = kumi::tuple{"x"_m = 1};
  constexpr auto t2 = kumi::tuple{"x"_m = 1.f, "y"_m = 2};
  constexpr auto t3 = kumi::tuple{"x"_m = 1., "y"_m = 2.f, "z"_m = 3};
  constexpr auto t4 = kumi::tuple{"x"_m = '1', 2., "z"_m = 3.f, 4};
