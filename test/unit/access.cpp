...
TTS_CASE("Check access to kumi::tuple with names via indexing")
{
  using namespace kumi::literals;
...
TTS_CASE("Check constexpr access to kumi::tuple with names via indexing")
{
  using namespace kumi::literals;
...
TTS_CASE("Check constexpr access to kumi::tuple with names via names")
{
  using namespace kumi::literals;
