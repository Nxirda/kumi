...
TTS_CASE("Check result::flatten/flatten_all<record> behavior")
{
  ...
  TTS_TYPE_IS ( (kumi::result::flatten_all_t<kumi::record<kumi::field_capture<"e", kumi::record<char_f,short_f>>
              ...
              , (kumi::record<char*,short*,int*,double*>)
              );
  ...
  TTS_TYPE_IS ( (kumi::result::flatten_all_t<kumi::record< kumi::field_capture<"e", kumi::record<char_f,short_f>>
              ...
              , (kumi::record<char const*,short const*,int const*,double const*>)
              );*/
};
...
TTS_CASE("Check record::flatten constexpr behavior")
{
  ...
  constexpr auto t1 = kumi::record {3.25f, kumi::record {2., 1, short {55}}, 'z'};
  constexpr auto t2 =
      kumi::record {3.25f, kumi::record {2., kumi::record {2., 1, short {55}}, short {55}}, 'z'};

  TTS_CONSTEXPR_EQUAL(kumi::flatten(kumi::record{}), kumi::record{});
  TTS_CONSTEXPR_EQUAL(kumi::flatten(t0), (kumi::record {2., 1, short {55}}));
  TTS_CONSTEXPR_EQUAL(kumi::flatten(t1), (kumi::record {3.25f, 2., 1, short {55}, 'z'}));
  TTS_CONSTEXPR_EQUAL(kumi::flatten(t2),
                      (kumi::record {3.25f, 2., kumi::record {2., 1, short {55}}, short {55}, 'z'}));
};

TTS_CASE("Check record::flatten_all behavior")
{
  TTS_EQUAL( kumi::flatten_all(kumi::record{}),kumi::record{});
  TTS_EQUAL((kumi::flatten_all(kumi::record{kumi::record{},kumi::record{},kumi::record{}})),kumi::record{});
  TTS_EQUAL((kumi::flatten_all(kumi::record {2., 1, short {55}})),
            (kumi::record {2., 1, short {55}}));
  TTS_EQUAL((kumi::flatten_all(kumi::record {3.25f, kumi::record {2., 1, short {55}}, 'z'})),
            (kumi::record {3.25f, 2., 1, short {55}, 'z'}));
  TTS_EQUAL((kumi::flatten_all(kumi::record {
                3.25f, kumi::record {2., kumi::record {2., 1, short {55}}, short {55}}, 'z'})),
            (kumi::record {3.25f, 2., 2., 1, short {55}, short {55}, 'z'}));
  TTS_EQUAL((kumi::flatten_all(kumi::record {
                3.25f, kumi::record {2., kumi::record{}, short {55}}, 'z'})),
            (kumi::record {3.25f, 2., short {55}, 'z'}));
};
...
TTS_CASE("Check record::flatten_all constexpr behavior")
{
  constexpr auto t0 = kumi::record {2., 1, short {55}};
  constexpr auto t1 = kumi::record {3.25f, kumi::record {2., 1, short {55}}, 'z'};
  constexpr auto t2 = kumi::record {3.25f, t0, t1, 'z'};
  constexpr auto te = kumi::record {3.25f, kumi::record {}, 'z'};

  TTS_CONSTEXPR_EQUAL(kumi::flatten_all(kumi::record{}),kumi::record{});
  TTS_CONSTEXPR_EQUAL(kumi::flatten_all(t0), (kumi::record {2., 1, short {55}}));
  TTS_CONSTEXPR_EQUAL(kumi::flatten_all(t1), (kumi::record {3.25f, 2., 1, short {55}, 'z'}));
  TTS_CONSTEXPR_EQUAL(kumi::flatten_all(te), (kumi::record {3.25f, 'z'}));
  TTS_CONSTEXPR_EQUAL(kumi::flatten_all(t2),
                      (kumi::record {3.25f, 2., 1, short {55}, 3.25f, 2., 1, short {55}, 'z', 'z'}));
};
